...
public class DecoratedBoxModelRenderer implements SpecialModelRenderer<DecoratedBoxComponent> {
   ...
   public DecoratedBoxModelRenderer(ShulkerBoxRenderer blockEntityRenderer, float openness, SpriteId textureId) {
   ...
   public void getExtents(Consumer<Vector3fc> vertices) {
      this.blockEntityRenderer.getExtents(this.openness, vertices);
   }

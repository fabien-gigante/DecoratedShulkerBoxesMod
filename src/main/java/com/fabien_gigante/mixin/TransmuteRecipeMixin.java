...
public class TransmuteRecipeMixin {
	...
	public ItemStack assemble(CraftingInput input) {
		...
		ItemStack craftedItem = this.result.apply(inputItem.getComponentsPatch());
		...
		if (this.result.item().is(ItemTags.SHULKER_BOXES)) {
			...
			DyeColor secondaryColor = extraDye.getItem() instanceof DyeItem ? extraDye.get(DataComponents.DYE) : null;
